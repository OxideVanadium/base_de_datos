...
left join ordenes as o on p.id_producto=o.id_producto
where id_orden is null;
/**
Mostrar el nombre del cliente, el producto y la cantidad para todas las órdenes **/
select c.nombre, p.*, o.cantidad from ordenes as o
...
select c.nombre, count(o.id_orden) from clientes as c 
join ordenes as o on c.id_cliente=o.id_cliente
